...
if sheet_data[0]["iataCode"] == "":
    ...
    flight_search.city_codes = flight_search.get_destination_code(city_names)
...
for destination_code in destinations:
    ...
    if flight.price < destinations[destination_code]["price"]:
        ...
        message = f"Low price alert! Only NTD{flight.price} to fly from {flight.origin_city}-{flight.origin_airport}" \
